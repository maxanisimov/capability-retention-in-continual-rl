"""Compatibility delegate for :mod:`experiments.pipelines.behaviour_retention.frozenlake_safety_constrained`."""
...
_CANONICAL_MODULE = "experiments.pipelines.behaviour_retention.frozenlake_safety_constrained"
