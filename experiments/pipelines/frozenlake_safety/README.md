...
```bash
python experiments/pipelines/frozenlake_safety/run_experiment.py \
  --mode source \
...
```bash
python experiments/pipelines/frozenlake_safety/cli/launch_full_pipeline_multi_seed.py \
  --pipeline diagonal_4x4 \
  --seeds 0 1 2 \
  --cores 0 1 2
```
...
```bash
python experiments/pipelines/frozenlake_safety/cli/launch_adaptation_multi_seed.py \
...
```bash
python experiments/pipelines/frozenlake_safety/aggregate_metrics_frozenlake_safety.py \
  --pipeline diagonal_4x4
```

Artifacts default to `experiments/pipelines/frozenlake_safety/artifacts/runs`.
