...
from experiments.pipelines.frozenlake_slippery_shield_safety.core.config import get_pipeline_config
from experiments.pipelines.frozenlake_slippery_shield_safety.core.pipeline import (
    adapt_downstream,
...
class FrozenLakeSafetyReferenceSettingsTests(unittest.TestCase):
    ...
    def test_downstream_ppo_matches_diagonal_4x4_settings_for_all_adapters(self) -> None:
        cfg = get_pipeline_config("diagonal_4x4")
        expected = frozenlake_slippery_shield_safety_diagonal_4x4_settings()["adaptation_ppo"]["ppo"]
