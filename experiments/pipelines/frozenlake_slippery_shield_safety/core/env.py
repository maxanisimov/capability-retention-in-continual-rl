"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake_slippery.core.env`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake_slippery.core.env"
