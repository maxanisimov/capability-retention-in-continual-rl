"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake_slippery.core.analysis`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake_slippery.core.analysis"
