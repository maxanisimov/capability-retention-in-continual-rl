"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake_slippery.test_paths_unittest`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake_slippery.test_paths_unittest"
