"""Launch source plus downstream FrozenLake slippery shield safety modes across seeds."""
...
from experiments.pipelines.frozenlake_slippery_shield_safety.core.paths import default_outputs_root, mode_run_dir, pipeline_root
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run source plus downstream modes for the FrozenLake slippery shield-safety pipeline.",
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Forwarded to source and downstream jobs."
        ),
    )
