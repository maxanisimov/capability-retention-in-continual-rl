"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake_slippery.cli`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake_slippery.cli"
