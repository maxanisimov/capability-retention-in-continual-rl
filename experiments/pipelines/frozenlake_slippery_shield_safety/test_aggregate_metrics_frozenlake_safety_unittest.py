"""Unit tests for FrozenLake slippery shield safety metric aggregation."""
...
from experiments.pipelines.frozenlake_slippery_shield_safety import aggregate_metrics_frozenlake_slippery_shield_safety as agg
...
class FrozenLakeSafetyAggregateMetricsTests(unittest.TestCase):
    def test_aggregates_defaults_and_writes_mean_pm_std_tables(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertIn(r"\label{tab:frozenlake_slippery_shield_safety_diagonal_4x4_metrics}", latex)
