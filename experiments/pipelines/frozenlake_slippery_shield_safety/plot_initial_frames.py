"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake_slippery.plot_initial_frames`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake_slippery.plot_initial_frames"
