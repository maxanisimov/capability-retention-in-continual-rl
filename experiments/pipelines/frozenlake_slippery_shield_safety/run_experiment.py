"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake_slippery.run_experiment`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake_slippery.run_experiment"
