"""Run unconstrained downstream adaptation across multiple seeds with CPU-core pinning."""
...
def _parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Run downstream_adaptation_unconstrained.py for one layout across multiple seeds, "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Default: <outputs-root>/<layout>/multi_seed_logs/downstream_unconstrained."
        ),
    )
    parser.add_argument(
        "--poll-seconds",
...
def main() -> int:
    ...
    log_dir = args.log_dir or (args.outputs_root / args.layout / "multi_seed_logs" / "downstream_unconstrained")
    ...
    print(
        f"Launching {len(seeds)} downstream runs for layout={args.layout} "
    ...
    print("\nAll downstream seed runs completed successfully.")
    return 0
