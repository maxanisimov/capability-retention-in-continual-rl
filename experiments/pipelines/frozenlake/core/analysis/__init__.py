"""Compatibility delegate for :mod:`experiments.pipelines.behaviour_retention.frozenlake.core.analysis`."""
...
_CANONICAL_MODULE = "experiments.pipelines.behaviour_retention.frozenlake.core.analysis"
