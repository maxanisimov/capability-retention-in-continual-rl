"""Compatibility delegate for :mod:`experiments.pipelines.behaviour_retention.frozenlake.cli`."""
...
_CANONICAL_MODULE = "experiments.pipelines.behaviour_retention.frozenlake.cli"
