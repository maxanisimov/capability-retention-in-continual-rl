"""Compatibility delegate for :mod:`experiments.pipelines.behaviour_retention.frozenlake.cli.adapt_rashomon`."""
...
_CANONICAL_MODULE = "experiments.pipelines.behaviour_retention.frozenlake.cli.adapt_rashomon"
