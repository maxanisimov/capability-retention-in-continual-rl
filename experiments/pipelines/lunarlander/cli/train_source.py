"""Compatibility delegate for :mod:`experiments.pipelines.behaviour_retention.lunarlander.cli.train_source`."""
...
_CANONICAL_MODULE = "experiments.pipelines.behaviour_retention.lunarlander.cli.train_source"
