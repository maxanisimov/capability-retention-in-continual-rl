"""Compatibility delegate for :mod:`experiments.pipelines.behaviour_retention.lunarlander.cli.adapt_ewc`."""
...
_CANONICAL_MODULE = "experiments.pipelines.behaviour_retention.lunarlander.cli.adapt_ewc"
