"""Compatibility delegate for :mod:`experiments.pipelines.behaviour_retention.lunarlander.cli.rollout_video`."""
...
_CANONICAL_MODULE = "experiments.pipelines.behaviour_retention.lunarlander.cli.rollout_video"
