"""Compatibility delegate for :mod:`experiments.pipelines.behaviour_retention.lunarlander.cli`."""
...
_CANONICAL_MODULE = "experiments.pipelines.behaviour_retention.lunarlander.cli"
