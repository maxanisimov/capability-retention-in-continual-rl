"""Compatibility delegate for :mod:`experiments.pipelines.behaviour_retention.lunarlander.core.methods`."""
...
_CANONICAL_MODULE = "experiments.pipelines.behaviour_retention.lunarlander.core.methods"
