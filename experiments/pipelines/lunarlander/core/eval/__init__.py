"""Compatibility delegate for :mod:`experiments.pipelines.behaviour_retention.lunarlander.core.eval`."""
...
_CANONICAL_MODULE = "experiments.pipelines.behaviour_retention.lunarlander.core.eval"
