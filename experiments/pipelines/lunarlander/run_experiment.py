"""Compatibility delegate for :mod:`experiments.pipelines.behaviour_retention.lunarlander.run_experiment`."""
...
_CANONICAL_MODULE = "experiments.pipelines.behaviour_retention.lunarlander.run_experiment"
