"""Compatibility delegate for :mod:`experiments.pipelines.behaviour_retention.lunarlander`."""
...
_CANONICAL_MODULE = "experiments.pipelines.behaviour_retention.lunarlander"
