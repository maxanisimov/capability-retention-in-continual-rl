"""Run one FrozenLake shield safety adaptation mode across seeds with CPU pinning."""
...
def _parse_args(argv: list[str] | None = None) -> tuple[argparse.Namespace, list[str]]:
    parser = argparse.ArgumentParser(
        description=(
            "Run one FrozenLake shield safety adaptation method across multiple seeds "
