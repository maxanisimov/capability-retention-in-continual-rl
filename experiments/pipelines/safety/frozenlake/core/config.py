...
SETTINGS_SOURCE = (
    ...
    "(experiments/pipelines/safety/frozenlake/settings/source/train_source_policy_settings.yaml, "
    "experiments/pipelines/safety/frozenlake/settings/adaptation/{ppo,ewc,rashomon}.yaml, "
    "experiments/pipelines/safety/frozenlake/settings/tasks/envs.yaml, "
    "experiments/pipelines/safety/frozenlake/settings/shield.yaml)"
)
N_ACTIONS = 4
OBS_DIM = 3
LAYOUT_NAME = LAYOUT
