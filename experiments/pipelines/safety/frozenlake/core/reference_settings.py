"""Settings for the FrozenLake shield-safety pipeline."""
...
def frozenlake_shield_safety_diagonal_4x4_settings() -> dict[str, Any]:
    """Return a defensive copy of the FrozenLake shield safety diagonal_4x4 settings."""
