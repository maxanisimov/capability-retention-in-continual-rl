"""Training and adaptation implementation for the FrozenLake shield-safety pipeline."""
...
from experiments.pipelines.safety.frozenlake.core.config import OBS_DIM, PipelineConfig, get_pipeline_config
from experiments.pipelines.safety.frozenlake.core.env import make_env, state_index_to_obs
from experiments.pipelines.safety.frozenlake.core.models import build_actor_critic
from experiments.pipelines.safety.frozenlake.core.constrained_ppo import (
    lagrangian_ppo_train,
    safe_line_search_ppo_train,
)
from experiments.pipelines.safety.frozenlake.core.paths import (
    NOADAPT_POLICY_SUBDIR,
    default_outputs_root,
    mode_run_dir,
    resolve_source_run_dir,
)
from experiments.pipelines.safety.frozenlake.core.safety import (
    RolloutResult,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the FrozenLake shield-safety pipeline.")
    parser.add_argument(
        "--mode",
        required=True,
        choices=[
