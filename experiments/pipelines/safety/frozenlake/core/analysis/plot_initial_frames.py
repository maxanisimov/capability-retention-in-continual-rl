"""Generate initial-frame figures for FrozenLake shield-safety task pairs."""
...
from experiments.pipelines.safety.frozenlake.core.config import (
    get_pipeline_config,
)
...
def save_initial_frame_figure(
    *,
    ...
    stem = basename or f"frozenlake_shield_safety_{layout}_initial_frames"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "FrozenLake Shield Safety pipeline layout."
        ),
    )
    parser.add_argument(
        "--pipeline",
