"""Run one LavaCrossing shield safety adaptation mode across seeds with CPU pinning."""
...
def _parse_args(argv: list[str] | None = None) -> tuple[argparse.Namespace, list[str]]:
    parser = argparse.ArgumentParser(
        description=(
            "Run one LavaCrossing shield safety adaptation method across multiple seeds "
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional transition slip probability override. Forwarded to the adaptation job."
        ),
    )
