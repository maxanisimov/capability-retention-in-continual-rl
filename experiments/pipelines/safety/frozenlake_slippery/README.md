...
```bash
python experiments/pipelines/safety/frozenlake_slippery/run_experiment.py \
  --mode source \
...
```bash
python experiments/pipelines/safety/frozenlake_slippery/cli/launch_full_pipeline_multi_seed.py \
  --pipeline diagonal_4x4 \
  --seeds 0 1 2 \
  --cores 0 1 2 \
  --success-rate 0.8
...
```bash
python experiments/pipelines/safety/frozenlake_slippery/cli/launch_adaptation_multi_seed.py \
...
```bash
python experiments/pipelines/safety/frozenlake_slippery/run_safe_line_search_ppo.py \
  --pipeline diagonal_4x4 \
  --seed 0
```
...
```bash
python experiments/pipelines/safety/frozenlake_slippery/run_lagrangian_ppo.py \
  --pipeline diagonal_4x4 \
  --seed 0
```
...
```bash
python experiments/pipelines/safety/frozenlake_slippery/aggregate_metrics_frozenlake_slippery_shield_safety.py \
  --pipeline diagonal_4x4
```
...
```bash
python experiments/pipelines/safety/frozenlake_slippery/plot_initial_frames.py \
  --pipeline diagonal_6x6
```
...
```bash
python experiments/pipelines/safety/frozenlake_slippery/plot_synthesised_shield.py \
  --pipeline diagonal_4x4 \
  --success-rate 0.8 \
  --shield-risk-threshold 0.05
```

Artifacts default to `experiments/pipelines/safety/frozenlake_slippery/artifacts/runs`.
Initial-frame figures default to
`experiments/pipelines/safety/frozenlake_slippery/artifacts/figures/initial_frames`.
Synthesized shield figures default to
`experiments/pipelines/safety/frozenlake_slippery/artifacts/figures/shields`.
