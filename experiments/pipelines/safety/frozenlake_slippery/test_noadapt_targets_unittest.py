...
from experiments.pipelines.safety.frozenlake_slippery.core.config import SOURCE_MAP
from experiments.pipelines.safety.frozenlake_slippery.core.env import obs_to_state_index
...
class FrozenLakeNoAdaptTargetTests(unittest.TestCase):
    def test_trajectory_states_are_one_hot_and_off_trajectory_stays_multihot(self) -> None:
        ...
        trajectory = [
            ...
            TrajectoryStep(step=1, state_index=1, row=0, col=1, action=0),
        ]
