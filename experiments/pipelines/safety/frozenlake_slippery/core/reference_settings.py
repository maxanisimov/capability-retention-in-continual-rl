"""Settings for the FrozenLake slippery shield-safety pipeline."""
...
def frozenlake_slippery_shield_safety_diagonal_4x4_settings() -> dict[str, Any]:
    """Return a defensive copy of the FrozenLake slippery shield safety diagonal_4x4 settings."""
