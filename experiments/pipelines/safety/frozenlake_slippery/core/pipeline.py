"""Training and adaptation implementation for the FrozenLake slippery shield-safety pipeline."""
...
from experiments.pipelines.safety.frozenlake_slippery.core.config import OBS_DIM, PipelineConfig, get_pipeline_config
from experiments.pipelines.safety.frozenlake_slippery.core.env import make_env, state_index_to_obs
from experiments.pipelines.safety.frozenlake_slippery.core.models import build_actor_critic
from experiments.pipelines.safety.frozenlake_slippery.core.constrained_ppo import (
    lagrangian_ppo_train,
    safe_line_search_ppo_train,
)
from experiments.pipelines.safety.frozenlake_slippery.core.analysis.plot_shield import (
...
from experiments.pipelines.safety.frozenlake_slippery.core.safety import (
    RolloutResult,
...
def train_source(args: argparse.Namespace) -> Path:
    ...
    shield, shield_info = synthesise_frozenlake_shield(
        cfg.source_map,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the FrozenLake slippery shield-safety pipeline.")
    parser.add_argument(
        "--mode",
        required=True,
        choices=[
