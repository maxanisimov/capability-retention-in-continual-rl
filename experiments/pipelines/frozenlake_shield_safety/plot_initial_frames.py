"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.plot_initial_frames`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.plot_initial_frames"
