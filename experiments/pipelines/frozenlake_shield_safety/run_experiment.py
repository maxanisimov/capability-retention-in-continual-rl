"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.run_experiment`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.run_experiment"
