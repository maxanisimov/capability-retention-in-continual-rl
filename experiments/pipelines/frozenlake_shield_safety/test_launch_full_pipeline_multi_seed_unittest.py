"""Unit tests for the FrozenLake shield safety full-pipeline launcher."""
...
from experiments.pipelines.frozenlake_shield_safety.cli import launch_full_pipeline_multi_seed as launcher
