"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.aggregate_layout_metrics`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.aggregate_layout_metrics"
