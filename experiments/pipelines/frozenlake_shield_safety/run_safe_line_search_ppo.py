"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.run_safe_line_search_ppo`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.run_safe_line_search_ppo"
