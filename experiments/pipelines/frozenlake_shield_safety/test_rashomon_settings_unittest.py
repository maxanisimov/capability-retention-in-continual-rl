"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.test_rashomon_settings_unittest`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.test_rashomon_settings_unittest"
