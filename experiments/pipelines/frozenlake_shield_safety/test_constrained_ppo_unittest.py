"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.test_constrained_ppo_unittest`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.test_constrained_ppo_unittest"
