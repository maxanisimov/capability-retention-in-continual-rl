"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.test_noadapt_targets_unittest`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.test_noadapt_targets_unittest"
