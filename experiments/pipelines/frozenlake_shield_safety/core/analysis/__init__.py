"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.core.analysis`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.core.analysis"
