"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.core.config`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.core.config"
