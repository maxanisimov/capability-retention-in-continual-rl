"""Static configuration for the FrozenLake shield-safety pipeline."""

from __future__ import annotations

from dataclasses import dataclass

from experiments.pipelines.frozenlake_shield_safety.core.reference_settings import (
    LAYOUT,
...
REFERENCE_SETTINGS = frozenlake_shield_safety_diagonal_4x4_settings()
...
SETTINGS_SOURCE = (
    f"FrozenLake Shield Safety {LAYOUT} "
    "(experiments/pipelines/frozenlake_shield_safety/settings/source/train_source_policy_settings.yaml, "
    "experiments/pipelines/frozenlake_shield_safety/settings/adaptation/{ppo,ewc,rashomon}.yaml, "
    "experiments/pipelines/frozenlake_shield_safety/settings/tasks/envs.yaml, "
    "experiments/pipelines/frozenlake_shield_safety/settings/shield.yaml)"
)
N_ACTIONS = 4
OBS_DIM = 3
LAYOUT_NAME = LAYOUT
