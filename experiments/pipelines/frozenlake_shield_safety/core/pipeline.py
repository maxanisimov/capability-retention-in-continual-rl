"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.core.pipeline`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.core.pipeline"
