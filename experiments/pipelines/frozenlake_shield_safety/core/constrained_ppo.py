"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.core.constrained_ppo`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.core.constrained_ppo"
