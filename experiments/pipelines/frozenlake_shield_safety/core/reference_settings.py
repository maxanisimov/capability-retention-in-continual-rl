"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.core.reference_settings`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.core.reference_settings"
