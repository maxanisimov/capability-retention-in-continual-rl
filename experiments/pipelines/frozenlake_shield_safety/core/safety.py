"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.core.safety`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.core.safety"
