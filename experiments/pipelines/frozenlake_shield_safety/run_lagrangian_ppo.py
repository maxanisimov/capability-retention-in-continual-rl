"""Compatibility delegate for :mod:`experiments.pipelines.safety.frozenlake.run_lagrangian_ppo`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.frozenlake.run_lagrangian_ppo"
