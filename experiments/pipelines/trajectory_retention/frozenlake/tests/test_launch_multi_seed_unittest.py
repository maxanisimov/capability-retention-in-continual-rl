"""Unit tests for the FrozenLake multi-seed launcher."""
...
from experiments.pipelines.trajectory_retention.frozenlake.cli import launch_multi_seed as launcher


class FrozenLakeLaunchMultiSeedTests(unittest.TestCase):
