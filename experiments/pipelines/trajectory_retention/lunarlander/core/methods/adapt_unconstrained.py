"""Adapt a NoAdapt LunarLander policy to downstream task via unconstrained PPO."""
...
# Allow running this file directly from experiments/pipelines/trajectory_retention/lunarlander/core/methods.
_REPO_ROOT = Path(__file__).resolve().parents[6]
if str(_REPO_ROOT) not in sys.path:
    sys.path.insert(0, str(_REPO_ROOT))

from experiments.pipelines._shared.adaptation_utils import neutralize_task_feature
from experiments.pipelines.trajectory_retention.lunarlander.core.env.env_factory import (
