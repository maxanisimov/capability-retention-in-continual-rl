...
- `experiments/pipelines/trajectory_retention/lunarlander`
...
- Compiled entire LunarLander subtree:
  - `python -m compileall -q experiments/pipelines/trajectory_retention/lunarlander`
...
- Add a concise `README.md` under `experiments/pipelines/trajectory_retention/lunarlander` describing:
