...
File: `experiments/pipelines/trajectory_retention/lunarlander/tunable_lunarlander.py`
...
- Registration entry point:
  - `experiments.pipelines.trajectory_retention.lunarlander.tunable_lunarlander:TunableLunarLander`
...
File: `experiments/pipelines/trajectory_retention/lunarlander/train_source_policy.py`
...
File: `experiments/pipelines/trajectory_retention/lunarlander/rollout_policy_video.py`
...
Files:
- `experiments/pipelines/trajectory_retention/lunarlander/settings/tasks/task_definitions.yaml`
- `experiments/pipelines/trajectory_retention/lunarlander/settings/tasks/task_pipelines.yaml`
...
from experiments.pipelines.trajectory_retention.lunarlander.tunable_lunarlander import ensure_lunarlander_v4_registered
