...
# 
# The notebook uses:
# - `experiments/pipelines/trajectory_retention/lunarlander/cli/launch_multi_seed.py` (mode = `downstream_rashomon`)
...
PIPELINE_ROOT = REPO_ROOT / "experiments/pipelines/trajectory_retention/lunarlander"
