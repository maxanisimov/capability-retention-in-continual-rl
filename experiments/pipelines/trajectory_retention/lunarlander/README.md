...
```bash
python experiments/pipelines/trajectory_retention/lunarlander/run_experiment.py \
  --mode source \
  --pipeline default \
  --seed 0
```
...
```bash
python experiments/pipelines/trajectory_retention/lunarlander/cli/launch_multi_seed.py \
  --mode downstream_ewc \
  --pipeline default \
  --seeds 0 1 2 3
```
...
```bash
python experiments/pipelines/trajectory_retention/lunarlander/cli/launch_full_pipeline_multi_seed.py \
  --pipeline default \
  --seeds 0 1 2 3
```
