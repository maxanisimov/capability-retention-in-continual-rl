"""Backward-compatible entrypoint for success/failure metrics evaluation."""
...
_CORE_MODULE_NAME = "experiments.pipelines.trajectory_retention.lunarlander.core.eval.evaluate_policy_success_metrics"
_CORE_MODULE_PATH = (
    _REPO_ROOT
    / "experiments"
    / "pipelines"
...
def _load_main():
    ...
    spec = importlib.util.spec_from_file_location("_lunarlander_eval_success_metrics_fallback", _CORE_MODULE_PATH)
