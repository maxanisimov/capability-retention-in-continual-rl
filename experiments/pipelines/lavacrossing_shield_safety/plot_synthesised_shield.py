"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.plot_synthesised_shield`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.plot_synthesised_shield"
