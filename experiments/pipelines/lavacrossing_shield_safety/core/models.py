"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.core.models`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.core.models"
