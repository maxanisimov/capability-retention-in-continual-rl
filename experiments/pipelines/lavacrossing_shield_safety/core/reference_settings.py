"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.core.reference_settings`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.core.reference_settings"
