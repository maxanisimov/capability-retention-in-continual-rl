"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.core.config`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.core.config"
