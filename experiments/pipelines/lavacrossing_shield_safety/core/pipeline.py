"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.core.pipeline`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.core.pipeline"
