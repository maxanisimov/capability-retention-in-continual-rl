"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.core.safety`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.core.safety"
