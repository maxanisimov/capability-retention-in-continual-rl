"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.core.analysis.plot_shield`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.core.analysis.plot_shield"
