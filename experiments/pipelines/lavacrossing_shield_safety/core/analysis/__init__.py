"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.core.analysis`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.core.analysis"
