"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.core.paths`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.core.paths"
