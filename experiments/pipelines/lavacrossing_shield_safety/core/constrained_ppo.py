"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.core.constrained_ppo`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.core.constrained_ppo"
