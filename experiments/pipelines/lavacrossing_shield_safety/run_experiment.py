"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.run_experiment`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.run_experiment"
