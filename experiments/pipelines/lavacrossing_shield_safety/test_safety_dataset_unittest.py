"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.test_safety_dataset_unittest`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.test_safety_dataset_unittest"
