"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.aggregate_layout_metrics`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.aggregate_layout_metrics"
