"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.cli.plot_initial_frames`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.cli.plot_initial_frames"
