"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.test_config_unittest`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.test_config_unittest"
