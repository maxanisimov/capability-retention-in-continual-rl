"""Compatibility delegate for :mod:`experiments.pipelines.safety.lavacrossing.run_lagrangian_ppo`."""
...
_CANONICAL_MODULE = "experiments.pipelines.safety.lavacrossing.run_lagrangian_ppo"
