...
- Compiled entire LunarLander subtree:
  - `python -m compileall -q experiments/pipelines/behaviour_retention/lunarlander`
...
- Add a concise `README.md` under `experiments/pipelines/behaviour_retention/lunarlander` describing:
