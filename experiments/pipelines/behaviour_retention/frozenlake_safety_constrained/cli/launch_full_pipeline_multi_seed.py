"""Launch source plus downstream FrozenLake safety modes across seeds."""
...
from experiments.pipelines.behaviour_retention.frozenlake_safety_constrained.core.paths import default_outputs_root, mode_run_dir, pipeline_root
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run source plus downstream modes for the FrozenLake safety pipeline.",
    )
