...
SETTINGS_SOURCE = (
    ...
    "(experiments/pipelines/behaviour_retention/frozenlake_safety_constrained/settings/source/train_source_policy_settings.yaml, "
    "experiments/pipelines/behaviour_retention/frozenlake_safety_constrained/settings/adaptation/{ppo,ewc,rashomon}.yaml, "
    "experiments/pipelines/behaviour_retention/frozenlake_safety_constrained/settings/tasks/envs.yaml)"
)
N_ACTIONS = 4
OBS_DIM = 3
LAYOUT_NAME = LAYOUT
