...
```bash
python experiments/pipelines/behaviour_retention/frozenlake/run_experiment.py \
  --mode source \
...
```bash
python experiments/pipelines/behaviour_retention/frozenlake/cli/launch_multi_seed.py \
  --mode downstream_ewc \
  --pipeline diagonal_30x30 \
  --seeds 0 1 2 3
```
...
```bash
python experiments/pipelines/behaviour_retention/frozenlake/cli/launch_full_pipeline_multi_seed.py \
  --pipeline diagonal_30x30 \
  --seeds 0 1 2 3
```
