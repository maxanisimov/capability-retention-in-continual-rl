...
```bash
python experiments/pipelines/safety_retention/frozenlake/run_experiment.py \
  --mode source \
...
```bash
python experiments/pipelines/safety_retention/frozenlake/cli/launch_full_pipeline_multi_seed.py \
  --pipeline diagonal_4x4 \
  --seeds 0 1 2 \
  --cores 0 1 2
```
...
```bash
python experiments/pipelines/safety_retention/frozenlake/cli/launch_adaptation_multi_seed.py \
...
```bash
python experiments/pipelines/safety_retention/frozenlake/aggregate_metrics_frozenlake_safety.py \
  --pipeline diagonal_4x4
```

Artifacts default to `experiments/pipelines/safety_retention/frozenlake/artifacts/runs`.
