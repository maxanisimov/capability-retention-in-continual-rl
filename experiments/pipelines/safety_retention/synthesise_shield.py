...
2. ``--env Custom...-v0``: a MASA-style tabular environment from
   experiments.utils.masa_tabular_envs (CustomMiniPacman-v0, CustomBridgeCrossing-v0, ...).
   The shield is synthesised with experiments.utils.shield_utils (exact tabular value
...
from experiments.pipelines.safety_retention.task_library import (
    environment_subdir,
    load_masa_task,
    masa_env_kwargs,
)
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "experiments.utils.masa_tabular_envs."
        ),
    )
    parser.add_argument(
        "--task",
