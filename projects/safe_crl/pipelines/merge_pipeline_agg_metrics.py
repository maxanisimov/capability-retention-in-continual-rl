...
def _default_input_root_for_pipeline(pipeline: str) -> Path:
    pipelines_root = _repo_root() / "projects" / "safe_crl" / "pipelines"
    if "/" in pipeline:
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Pipeline name under projects/safe_crl/pipelines, e.g. lunarlander or "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Defaults to projects/safe_crl/pipelines/<pipeline>/artifacts/runs when "
