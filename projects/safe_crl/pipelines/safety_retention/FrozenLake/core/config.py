...
SETTINGS_SOURCE = (
    ...
    "(projects/safe_crl/pipelines/safety_retention/frozenlake/settings/source/train_source_policy_settings.yaml, "
    "projects/safe_crl/pipelines/safety_retention/frozenlake/settings/adaptation/{ppo,ewc,rashomon}.yaml, "
    "projects/safe_crl/pipelines/safety_retention/frozenlake/settings/tasks/{tasks,pipelines}.yaml)"
)
N_ACTIONS = 4
OBS_DIM = 3
LAYOUT_NAME = LAYOUT
