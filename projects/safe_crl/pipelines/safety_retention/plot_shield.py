...
from projects.safe_crl.pipelines.safety_retention.task_library import environment_subdir
...
def plot_masa(payload: dict, fixed_features: dict | None, *, seed: int, output_path: Path) -> None:
    ...
    from projects.safe_crl.utils.masa_tabular_envs.visualisation import build_shield_layout
