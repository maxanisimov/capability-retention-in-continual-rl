...
from projects.safe_crl.pipelines.trajectory_retention.frozenlake.core.orchestration.run_paths import default_source_envs_file
...
def main() -> None:
    out_path = default_source_envs_file()
