"""Single entrypoint: launch a multi-seed FrozenLake pipeline run and aggregate results.

    python run_pipeline.py --pipeline diagonal_30x30 --rl ppo \\
...
from projects.safe_crl.pipelines.trajectory_retention.frozenlake.cli import launch_multi_seed
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Launch a multi-seed FrozenLake pipeline run, then aggregate results.",
    )
