...
- Compiled entire LunarLander subtree:
  - `python -m compileall -q projects/safe_crl/pipelines/trajectory_retention/lunarlander`
...
- Add a concise `README.md` under `projects/safe_crl/pipelines/trajectory_retention/lunarlander` describing:
