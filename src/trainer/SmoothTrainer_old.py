...
class SmoothTrainer(BaseTrainer):
    def __init__(
        self,
        model: nn.Module,
        ...
        **rashomon_kwargs: dict,
        ...
        self._last_projection = -1 # Always -1 in my case as we can impliment this feature later
        ...
        self.loc = [] # ! mu
        self.scale = [] # ! sigma
        self.radius = None # ! I think this might be the alpha value
        self.num_classes = 10
    ...
    # We cannot remove this as we compute interval bounds at the moment inside of this class...
