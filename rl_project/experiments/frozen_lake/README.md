...
Single seed:
```bash
python rl_project/experiments/frozen_lake/run_train_and_adapt.py --cfg standard_4x4 --seed 0
```

Multi-seed:
```bash
python rl_project/experiments/frozen_lake/run_train_and_adapt_multi_seed.py --cfg standard_4x4
```

Dry-run multi-seed commands:
```bash
python rl_project/experiments/frozen_lake/run_train_and_adapt_multi_seed.py --cfg standard_4x4 --dry-run
```
